...
imported. The restriction is usually enforced by issuing licenses to some group of individuals or firms. For example, the United States has a quota on imports of foreign
...
a voluntary restraint agreement (VRA). A VER is a quota on trade imposed
...
physical units. In other cases, the requirement is stated in value terms by requiring that some minimum share of the price of a good represent domestic value added. Local content laws have been widely used by
...
This is like an export subsidy except that it takes the form
...
Purchases by the government or strongly regulated firms can
...
industry. For instance, I Europe, government-owned telephone companies buy from
domestic suppliers even when the suppliers charge higher prices than suppliers in
other countries.

### Red-tape barriers 

Sometimes a government wants to restrict imports without doing
